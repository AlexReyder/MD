			...
			<ul className={s.List}>
				<li className={s.Item}>
						...
						<div className={s.Content}>
								<h3>Футболки &rarr;</h3>
								<Link href='/catalog/futbolki' className={s.Link}>Перейти</Link>
						</div>
				</li>
				<li className={s.Item}>
						...
						<div className={s.Content}>
								<h3>Лонгсливы</h3>
								<Link href='/catalog/lognslivy' className={s.Link}>Перейти</Link>
						</div>
				</li>
				<li className={s.Item}>
						...
						<div className={s.Content}>
								<h3>Флаги</h3>
								<Link href='/catalog/flagi' className={s.Link}>Перейти</Link>
						</div>
				</li>
				<li className={s.Item}>
						...
						<div className={s.Content}>
								<h3>Нашивки</h3>
								<Link href='/catalog/nashivki' className={s.Link}>Перейти</Link>
						</div>
				</li>
			</ul>
		</Section>
