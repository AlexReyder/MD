...
export type CartItems = z.infer<typeof productFormSchema>[]
export type CartItem = z.infer<typeof productFormSchema>
export interface ICartGetProducts {
	success: CartItems | [],
	error: string | null  
}
...
export interface ICartGetProductsLength {
	success: number,
	error: string | null  
}
